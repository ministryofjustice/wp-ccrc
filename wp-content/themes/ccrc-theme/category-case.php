...
<!-- 			<div class="stats">
          ...
          <ul>
            <li><span>Completed:</span> <?php echo get_post_meta( 157, "completed-referrals", true ); ?> referrals (<?php echo get_post_meta( 157, "completed-referrals-ineligible", true ); ?> incl. ineligible)</li>
